...
<input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
 ...
 <p class="fsize-text">
                      ...
                      Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" required name="password" value="<?php echo $password; ?>"><br><br><br><br><br><br><br>
        ...
        <h2  class="headspace2 font infospace"> Personal Information <hr class="hr" style="border-bottom: 4px solid #2d70d5;"> </h2>
            ...
            Middle name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' id="Mname" name="Mname" value="<?php echo $mname; ?>"><br><br>

            Last name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' id="Lname" required name="Lname" value="<?php echo $lname; ?>"><br><br>
            ...
            Contact Number:&nbsp;&nbsp;<input class="textbox" maxlength="10" type="text" id="contact" onkeypress="return isNumber(event)" required name="contact" value="<?php echo $contact; ?>"><br><br>
            ...
            City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="textbox" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' type="text" id="province" name="province" value="<?php echo $province; ?>"><br><br>
