...
$query_category="SELECT buy_transaction.transaction_id,buy_transaction.delivery_date,buy_transaction.ordered_no,buy_transaction.ordered_date,buy_transaction.total_price,buy_transaction.shipping_status,user.user_email,buy_transaction.courier_name
      ...
      <div class="whiteborder">
        <h3> Dear '.$courier_name.',</h3>
         ...
         <p>
            Your Order # '.$id.' has been placed on '.$ordered_date.'.
            <br><br>

            Note:<br><br>
            In the event that the information you provided is incomplete, a validation may be sent through phone call or SMS as part of Artwork Gallery\'s order verification requirement.<br> Please be kind enough to respond if you receive either a call from Artwork Gallery or an SMS from sender Artwork Gallery. If you do not receive any communication from us your order will automatically be processed.<br><br>
            ...
            After your order is validated, it will be shipped to you by the delivery date.
        </p>
        </div>
        ';
    }
