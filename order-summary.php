    ...
    <div id="content">
        ...
        <form  class="border" action = "shipping_process(planb).php" method="POST" > <br><br><br><br><br><br><br><br><br><br>
              ...
              <p class="fsize-special">
                  ...
                  <?php echo $area.', India<br>'.$house_num. '-'.$street.', '.$brgy.' ,'.$municipal.' ,'.$province; ?><br>
         ...
         <p class="delivery">
          <?php
           ...
           <p class="price">&#8377 <?php echo $price;?>.00 <br><br><br><br><br></p><br>

           <p class="special">Subtotal: &#8377 <?php echo $total_price;?>.00<br>
           ...
           <p class="total">Total(Tax included): &#8377 <?php echo $total_price;?>.00</p>
