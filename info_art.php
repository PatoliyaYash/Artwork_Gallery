...
if($row['art_status'] == 'SOLD'){
    echo '<p class="soldbutton">'.$row['art_status'].' for<br> &#8377 '.$row['art_price'].'.00</form>';
}
else if($row['art_status'] == 'AVAILABLE' && $row['art_stock'] == 0){
       echo '<p class="soldbutton"> SOLD OUT <br> &#8377 '.$row['art_price'].'</form>';
     }
else{
       echo '<input  class="buybutton" type="submit" name="buy" value="BUY for &#8377 '.$row['art_price'].'"><br>
	   </form>';
     }
