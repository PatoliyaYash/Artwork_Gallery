  ...
  <div class="login-background">
   <div class="topmargin">
        <form action = "login.php" method="POST">
            ...
            <p class="user">User </p>
                        <p class="name"> name: <input class="userbar" type="text" id ="username"  placeholder= " Enter Username" required name="username"> <br><br></p>
            <p class="pass" >Pass </p>
                        <p class="word">  word: <input class="passwdbar" type="password" id="password"  placeholder= " Enter Password" required name="password"> <br><br></p>
