...
<body>
  ...
  <option value="">FOR SCULPTURE MEDIUM </option>
      ...
      <option value="">FOR PHOTOGRAPHY MEDIUM</option>
                 ...
                 <option value="5001">less than 5,000 &#8377</option>
                 <option value="10001">less than 10,000 &#8377</option>
                 <option value="50001">less than 50,000 &#8377</option>
                 <option value="500001">less than 500,000 &#8377</option>
                  <option value="1000001">less than 1,000,000 &#8377</option>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        '<a  href=info_art.php?id='.$row['art_id'].' class="desc-title"> '.$row['art_title'].' </a>
                                         ...
                                         <p class="desc-content" style="float: right;">&#8377 '.$row['art_price'].'.00</p> <br>
