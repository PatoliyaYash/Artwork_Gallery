...
<br><br>
Width:<input class="textbox" type="text" onkeypress="return isNumber(event)" id="Mname" required name="width" value="<?php echo $art_width; ?>"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; in.
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Height:<input class="textbox2" type="text" onkeypress="return isNumber(event)" id="Lname" required name="height" value="<?php echo $art_height; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; in.
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Thickness:<input class="textbox2" type="text" onkeypress="return isNumber(event)" id="gender" required name="thickness" value="<?php echo $art_thickness; ?>"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; in.<br><br>
...
Price(&#8377;):&nbsp;&nbsp;<input class="textbox" onkeypress="return isNumber(event)" type="text" required name="price" value="<?php echo $art_price; ?>"><br><br>
<?php
if($art_category == 'Sculpture'){
  echo '
Stock:&nbsp;&nbsp;<input class="textbox" type="text" onkeypress="return isNumber(event)" required name="stock" value="'.$art_stock.'"><br><br>';
}
?>
