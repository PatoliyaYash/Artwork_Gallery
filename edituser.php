...
<input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
 ...
 <p class="fsize-text">
        ...
        <h2  class="headspace2 font infospace"> Personal Information <hr class="hr" style="border-bottom: 4px solid #2d70d5;"> </h2>
            ...
            Gender:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" onkeypress='return((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' type="text" id="gender" required name="gender" value="<?php echo $gender; ?>"><br><br>

            Birthdate:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="date" id="bday" name="bday" value="<?php echo $bday; ?>"><br><br>

            Contact Number:&nbsp;&nbsp;<input class="textbox" type="text" id="contact" maxlength="13" onkeypress="return isNumber(event)" required name="contact" value="<?php echo $contact; ?>"><br><br>
